...
def searchbook(request):
    if request.method == "POST":
        ...
        books = models.Book.objects.filter(author__contains=searched )
        return render(request,'library/searchbook.html',{'searched':searched,'books':books})
    else:
...
def contactus_view(request):
    ...
    if request.method == 'POST':
        ...
        if sub.is_valid():
            ...
            send_mail(str(name)+' || '+str(email),message, EMAIL_HOST_USER, ['abhinavkdps@gmail.com'], fail_silently = False)
